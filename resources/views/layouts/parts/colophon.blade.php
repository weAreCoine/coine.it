...
<div id="colophon" class="grid grid-cols-12 gap-8 container items-start my-12">
    <div class="col-span-6">
        <p class="text-2xl">BB Agency is a strategic partner for fast-growing tech companies in need of a scalable
            website with modular CMS, a design system, and future-proof brand identity.</p>

        <p class="text-xl mt-8 flex items-center gap-4"><i class="fa-solid min-w-[1.5rem] fa-location-dot "></i><a
        ...
        <p class="text-xl mt-4 flex items-center gap-4"><i class="fa-solid min-w-[1.5rem] fa-mobile-retro"></i><a
                href="tel:00393454476837">+39 345 447 6837</a></p>
        <p class="text-xl mt-4 flex items-center gap-4 "><i class="fa-solid min-w-[1.5rem] fa-feather-pointed"></i><a
                href="mailto:ciao@coine.it">ciao@coine.it</a></p>
    </div>
    <div class="col-span-2">
        <h2 class="text-accent-500 uppercase tracking-widest mb-8 font-semibold">NAVIGATION</h2>
        <ul>
    ...
    <div class="col-span-2">
        <h2 class="text-accent-500 uppercase tracking-widest mb-8 font-semibold">Utilities</h2>
        <ul>
    ...
    <div class="col-span-2">
        <h2 class="text-accent-500 uppercase tracking-widest mb-8 font-semibold">Links</h2>
        <ul>
