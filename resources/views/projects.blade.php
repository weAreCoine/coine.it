...
@section('content')
    <div x-data="getStartProjectData()">
        <div class="container pt-12">
            <div class="w-5/6 mx-auto">
                ...
                <form action="" method="POST">
                    @csrf
                    <div class="rounded-2xl bg-slate-800/40 mt-20 p-16">
                        ...
                        <ul class="mt-12 flex flex-wrap gap-x-4 gap-y-8">
                            <template x-for="(label, value) in servicesChips" :key="value">
                                <li class="cursor-pointer flex items-center gap-3 font-medium rounded-full border border-slate-300 px-6 py-2 text-2xl inline-block duration-500"
                                    :class="{
                                    'bg-orange-500 hover:bg-orange-600 border-sky-900 text-white font-semibold': selectedServices.includes(value),
                                    'text-slate-400 hover:text-white': !selectedServices.includes(value)
                                }"
                    ...
                    <div class="rounded-2xl bg-slate-800/40 mt-12 p-16">
                    ...
                    <div class="rounded-2xl bg-slate-800/40 mt-12 p-16">
                        ...
                        <textarea required
                                  ...
                                  class="w-full mt-8 border-b border-b-slate-300 bg-transparent outline-none text-2xl placeholder-slate-500"
            ...
            <div class="grid grid-cols-3 mt-20 gap-x-8 gap-y-24">
                ...
                <div class="col-start-3 row-start-2">
                    ...
                    <a href="https://goo.gl/maps/Nzen6mimbRcrj6fb8"
                       class="style-none block mt-8 text-xl text-slate-400 leading-relaxed">
        ...
        <div class="bg-gradient-to-b from-slate-900 to-slate-800 py-24 mt-24 mb-0">
        ...
        <div class="bg-gradient-to-b from-slate-800 to-slate-900 pt-24">
            <div class="container ">
